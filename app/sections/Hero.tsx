...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute z-60 top-[8vh] sm:top-[15%] lg:top-[15%] w-full h-full main-text px-4 sm:px-6 lg:px-8">
      ...
      <section className="hero relative z-20 h-screen w-full ">
        ...
        <div className="relative w-full h-full flex flex-col justify-evenly items-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center justify-center gap-2 w-[95%] sm:w-[90%] max-w-[40rem] h-[60%] sm:h-[70%] mt-1 sm:mt-10 lg:mt-24">
